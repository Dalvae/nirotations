local math_max, tonumber, UnitGUID, pairs, type, tinsert, UnitLevel, UnitThreatSituation, GetUnitSpeed, UnitExists, tostring, strsub, UnitIsDeadOrGhost, UnitCanAttack, UnitHealth, UnitHealthMax, UnitGetIncomingHeals, select, GetTime, math_pow, wipe, UnitReaction, UnitCastingInfo, UnitChannelInfo, UnitBuff, strlower, tContains, GetSpellInfo, strupper, strfind, strlen, UnitDebuff, UnitClass =
		math.max, tonumber, UnitGUID, pairs, type, tinsert, UnitLevel, UnitThreatSituation, GetUnitSpeed, UnitExists,
		tostring,
		strsub, UnitIsDeadOrGhost, UnitCanAttack, UnitHealth, UnitHealthMax, UnitGetIncomingHeals, select, GetTime, math.pow,
		wipe, UnitReaction, UnitCastingInfo, UnitChannelInfo, UnitBuff, strlower, tContains, GetSpellInfo, strupper, strfind,
		strlen, UnitDebuff, UnitClass
local creaturetypes = {
	[0] = "Unknown",
	[1] = "Beast",
	[2] = "Dragon",
