...
function world.get_2d_distance(x1, y1, x2, y2)
   return ni.functions.getdistance(x1, y1, x2, y2)
end
...
function world.get_3d_distance(x1, y1, z1, x2, y2, z2)
   return ni.functions.getdistance(x1, y1, z1, x2, y2, z2)
end
...
function world.trace_line(x1, y1, z1, x2, y2, z2, hit_flags)
   return ni.functions.los(x1, y1, z1, x2, y2, z2, hit_flags)
end
