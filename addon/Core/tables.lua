local tables = {
	blacklistedaoeunits = {},
	blacklisteddispels = {
		2819, 2824, 11355, 11356, 16427, 20184, 20185, 20186, 25351, 26967, 27186, GetSpellInfo(30129), 31803, 32859, 34616, 34856, 36814, 37132, 37930, 38136, 38141, 38142, 38143, 39042, 41486,
		GetSpellInfo(47843), GetSpellInfo(48160), 53742, 55360, GetSpellInfo(57970), 57973, 57972, 60667, 60814, 61429, 61840, 68055, 68786, 69674, 70337, 70405, 70867, 70964, 71224, 71889, 72908, 74562, 74567, 74792, 74795
	},
	bosses = {
		-- Ragefire Chasm
