...
if build == 30300 and data then
	...
	local abilities = {
		...
		["Judgement of Light"] = function()
			if ni.spell.available("Judgement of Light")
					and ni.spell.valid("target", "Judgement of Light", false, true, true) then
	...
	ni.bootstrap.profile("LevelingPaladin", queue, abilities, OnLoad, OnUnLoad);
else
	local queue = {
		"Error",
	}
	...
	ni.bootstrap.profile("LevelingPaladin", queue, abilities);
end
